...
class _HomeWidgetState extends State<HomeWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.apiResultCheck = await ApiNokiPayGroup.getUserCall.call(
        accessToken: FFAppState().accessToken,
      );

      if ((_model.apiResultCheck?.statusCode ?? 200) == 401) {
        ...
        navigate = () => context.goNamedAuth('Onboarding', context.mounted);
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  FutureBuilder<ApiCallResponse>(
                                    future: ApiNokiPayGroup.getNewsCall.call(),
