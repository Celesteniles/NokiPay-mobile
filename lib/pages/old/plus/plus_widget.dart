...
import 'plus_model.dart';
export 'plus_model.dart';
...
class _PlusWidgetState extends State<PlusWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlusModel());
  }
