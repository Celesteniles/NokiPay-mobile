                                                          ...
                                                          children: [
                                                            Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'nwn9zof1' /* Solde du portefeuille */,
                                                              ),
                                                              textAlign:
                                                                  TextAlign.end,
                                                              maxLines: 2,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      FFLocalizations.of(context).getText(
                        'd6gr7m93' /* Que voudriez-vous faire ? */,
                      ),
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            fontFamily:
                                FlutterFlowTheme.of(context).bodyMediumFamily,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'amuw16f9' /* Service de livraison express */,
                              ),
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
