                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        width: double.infinity,
                        child: TextFormField(
                          controller: _model.numeroRueTextController,
                          focusNode: _model.numeroRueFocusNode,
                          autofocus: false,
                          autofillHints: const [AutofillHints.name],
                          textCapitalization: TextCapitalization.none,
                          obscureText: false,
                          ...
                          validator: _model.numeroRueTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      SizedBox(
                        width: double.infinity,
                        child: TextFormField(
                          controller: _model.rueTextController,
                          focusNode: _model.rueFocusNode,
                          autofocus: false,
                          autofillHints: const [AutofillHints.name],
                          textCapitalization: TextCapitalization.none,
                          obscureText: false,
                          ...
                          validator: _model.rueTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      SizedBox(
                        ...
                        child: TextFormField(
                          ...
                          validator: _model.avenueTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      SizedBox(
                        width: double.infinity,
                        child: TextFormField(
                          controller: _model.quartierTextController,
                          focusNode: _model.quartierFocusNode,
                          autofocus: false,
                          autofillHints: const [AutofillHints.name],
                          textCapitalization: TextCapitalization.none,
                          obscureText: false,
                          ...
                          validator: _model.quartierTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      SizedBox(
                          ...
                          children: [
                            TextSpan(
                              text: FFLocalizations.of(context).getText(
                                'y277einr' /* En vous inscrivant, vous accep... */,
                              ),
                              style: const TextStyle(),
                            ),
                            TextSpan(
                              text: FFLocalizations.of(context).getText(
                                'u4zqeriy' /* les conditions d'utilisation */,
                              ),
                              style: TextStyle(
                                color: FlutterFlowTheme.of(context).primary,
                                fontWeight: FontWeight.bold,
                              ...
                              recognizer: TapGestureRecognizer()
                                ..onTap = () async {
                                  await launchURL('http://nokipay.net/');
                                },
                            )
                          ],
                          style: FlutterFlowTheme.of(context)
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            _model.apiResultRegister =
                                await ApiNokiPayGroup.registerCall.call(
                              nom: _model.nomTextController.text,
                              prenom: _model.prenomTextController.text,
                              sexe: _model.dropDownValue,
                              mobile: _model.telephoneTextController.text,
                              ville: _model.villeTextController.text,
                              quartier: _model.quartierTextController.text,
                              avenue: _model.avenueTextController.text,
                            ...
                            if ((_model.apiResultRegister?.succeeded ?? true) &&
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'Quelque ne s\'est pas bien passé',
                                    style: TextStyle(
                                      color: FlutterFlowTheme.of(context)
                                          .primaryText,
                                    ),
                      ...
                      RichText(
                        ...
                        text: TextSpan(
                          children: [
                            TextSpan(
                              text: FFLocalizations.of(context).getText(
                                'bita762j' /* Déjà un compte ?  */,
                              ),
                              style: const TextStyle(),
                            ),
                            TextSpan(
                              text: FFLocalizations.of(context).getText(
                                'r9vkzqts' /* Se connecter */,
                              ),
                              style: TextStyle(
                                color: FlutterFlowTheme.of(context).primary,
                                fontWeight: FontWeight.bold,
