...
class _LoginCopyWidgetState extends State<LoginCopyWidget>
  ...
  void initState() {
    ...
    _model.countryTextController1 ??= TextEditingController();

    _model.countryTextController2 ??= TextEditingController();
                                ...
                                child: Autocomplete<String>(
                                  ...
                                  optionsViewBuilder:
                                    ...
                                    return AutocompleteOptionsList(
                                      textFieldKey: _model.countryKey1,
                                      textController:
                                          _model.countryTextController1!,
                                  ...
                                  fieldViewBuilder: (
                                    ...
                                    _model.countryFocusNode1 = focusNode;

                                    _model.countryTextController1 =
                                        textEditingController;
                                    return TextFormField(
                                      key: _model.countryKey1,
                                      ...
                                      validator: _model
                                          .countryTextController1Validator
                                          .asValidator(context),
                                    );
                                  },
                                ),
                              ...
                              Expanded(
                                child: Autocomplete<String>(
                                  ...
                                  optionsViewBuilder:
                                      (context, onSelected, options) {
                                    return AutocompleteOptionsList(
                                      textFieldKey: _model.countryKey2,
                                      textController:
                                          _model.countryTextController2!,
                                      options: options.toList(),
                                      onSelected: onSelected,
                                      textStyle: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                  ...
                                  fieldViewBuilder: (
                                    ...
                                    _model.countryFocusNode2 = focusNode;

                                    _model.countryTextController2 =
                                        textEditingController;
                                    return TextFormField(
                                      key: _model.countryKey2,
                                      controller: textEditingController,
                                      focusNode: focusNode,
                                      onEditingComplete: onEditingComplete,
                                      autofocus: false,
                                      ...
                                      validator: _model
                                          .countryTextController2Validator
                                          .asValidator(context),
                                    );
                                  },
                                ),
                      ...
                      RichText(
                        ...
                        text: TextSpan(
                          children: [
                            TextSpan(
                              text: FFLocalizations.of(context).getText(
                                'hpmfh8y4' /* Pas de compte ?  */,
                              ),
                              style: const TextStyle(),
                            ),
                            TextSpan(
                              text: FFLocalizations.of(context).getText(
                                'tmodz2x1' /* Créer un compte */,
                              ),
                              style: TextStyle(
                                color: FlutterFlowTheme.of(context).primary,
                                fontWeight: FontWeight.bold,
