...
import 'choose_country_model.dart';
export 'choose_country_model.dart';
...
class _ChooseCountryWidgetState extends State<ChooseCountryWidget> {
  late ChooseCountryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChooseCountryModel());
  }
                      ...
                      child: Builder(
                        builder: (context) {
                          ...
                          return SingleChildScrollView(
                            child: Column(
                              mainAxisSize: MainAxisSize.max,
                              children: List.generate(countryVar.length,
                                      (countryVarIndex) {
                                final countryVarItem =
                                    countryVar[countryVarIndex];
                                return Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    InkWell(
