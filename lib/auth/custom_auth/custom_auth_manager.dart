...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    nokiPayAuthUserSubject.add(
      NokiPayAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<NokiPayAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  NokiPayAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = NokiPayAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    nokiPayAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
