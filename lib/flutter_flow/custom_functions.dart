...
String? getCountryFlag(String? countryName) {
  ...
  final countryInfoJson = {
    ...
    "Congo Kinshasa": {"dial_code": "+243", "code": "CD"},
...
String? arrayToString(List<String>? liste) {
  // Utiliser la méthode join pour concaténer les éléments de la liste en une seule chaîne
...
bool estMajeur(DateTime dateNaissance) {
...
bool veriferPhone(String phoneNumber) {
  return phoneNumber.length >= 9 && phoneNumber.length < 12;
}

bool veriferPin(String code) {
  return code.length >= 4 && code.length < 7;
}
